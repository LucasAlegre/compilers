...
static const yytype_uint8 yyrline[] =
{
     ...
     101,   104,   105,   106,   109,   110,   113,   114,   117,   118,
     121,   122,   125,   128,   131,   134,   135,   138,   139,   140,
...
#line 87 "parser.y" /* yacc.c:1646  */
    {Root=(yyval.astree); astree_print(0, Root); SemanticErrors=semanticVerification(Root); TACs=rewindTac(createTacs(Root, 0));}
