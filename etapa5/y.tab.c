...
{
       0,    86,    86,    89,    90,    93,    94,    95,    98,    99,
     100,   103,   104,   105,   108,   109,   112,   113,   116,   117,
     120,   121,   124,   127,   130,   133,   134,   137,   138,   139,
...
#line 86 "parser.y" /* yacc.c:1652  */
    {Root=(yyval.astree); astree_print(0, Root); SemanticErrors=semanticVerification(Root); printAllTacs(rewindTac(createTacs(Root, 0)));}
